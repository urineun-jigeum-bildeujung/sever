...
public class KafkaProducerConfig {
    ...
    // SASL 전환 6단계(2026-09-18). 값이 없으면(현재 평문 9092) 기존 동작 그대로 유지 -
    // gitops-value에서 이 값들이 채워지기 전까지는 조건문이 항상 false라 안전함.
    // order/product-service(#82/#83)와 동일 패턴(CodeRabbit 지적사항 반영된 버전).
