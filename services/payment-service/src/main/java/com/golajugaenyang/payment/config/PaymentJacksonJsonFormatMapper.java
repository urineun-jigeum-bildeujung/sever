...
public class PaymentJacksonJsonFormatMapper extends AbstractJsonFormatMapper {

    private final JsonMapper jsonMapper;

    public PaymentJacksonJsonFormatMapper() {
        this(JsonMapper.builder().build());
    }

    public PaymentJacksonJsonFormatMapper(JsonMapper jsonMapper) {
    ...
    public <T> T fromString(CharSequence charSequence, Type type) {
        return jsonMapper
            .readValue(charSequence.toString(), jsonMapper.constructType(type));
    }
